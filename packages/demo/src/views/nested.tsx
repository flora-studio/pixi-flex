...
import { Align, FLEX_AFTER_LAYOUT, FlexContainer, FlexDirection, Justify, PositionType } from '@florastudio/pixi-flex'
...
async function init(app: Application) {
  ...
  dialogBackground.on(FLEX_AFTER_LAYOUT, ({ width, height }: { width: number, height: number }) => {
